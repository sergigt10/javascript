...
// auto -> son los automoviles passados en -> obtenerAutos().filter(filtrarMarca)
// Filter genera un array con los resultados encontrados.
function filtrarMarca(auto) {
    if(datosBusqueda.marca){
        return auto.marca === datosBusqueda.marca;
    } else {
        // Si no puede encontrar nada que me devuelva el anterior filtrado.
        return auto;
    }
}
