class Interfaz {
     // Cargamos construirSelect desde el constructor.
     // El constructor se ejecuta cuando se instancia la classe Interfaz.
     constructor() {
          this.init();
     }
     init() {
     ...
     construirSelect() {
          cotizador.obtenerMonedasAPI()
               .then(monedas => {
                    ...
                    // Object.entries -> transforma los objetos a arrays.
