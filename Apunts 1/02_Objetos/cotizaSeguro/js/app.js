...
// Todo lo que se muestra (classe)
function Interfaz() {}

// Mensaje que se imprime en el HTML
Interfaz.prototype.mostrarMensaje = function(mensaje, tipo) {
     // Creemos el elemento div
     const div = document.createElement('div');

     if(tipo === 'error') {
          // Añadimos las classes
          div.classList.add('mensaje','error');
     } else {
          div.classList.add('mensaje','correcto');
     }
     div.innerHTML = `${mensaje}`;
     // Dos parametros: elemento que queremos insertar y antes de que tiene que ir.
...
formulario.addEventListener('submit', function(e) {
     ...
     // lee el valor del radio button escogido
...
// Màximo coche para asegurar
const max = new Date().getFullYear(),
      min = max - 20;

// Seleccionamos el selector de años para crear un selector
